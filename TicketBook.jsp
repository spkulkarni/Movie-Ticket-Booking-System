...
String a[];
a=new String[20];
PreparedStatement ps=con.prepareStatement("SELECT * FROM movie.tickets natural join movie.theatre natural join movie.show join movie.movies on show_id=m_id where tittle=?");
//if(name=="one")
ps.setString(1,name);
